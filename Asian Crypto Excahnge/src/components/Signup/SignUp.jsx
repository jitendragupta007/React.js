...
const SignUp = () => {
  ...
  const [cnfmPasswordType, setCnfmPasswordType] = useState(true);
  ...
  const handleCnfmPassword = () => {
    return setCnfmPasswordType(!cnfmPasswordType);
  };

  console.log("otpcheck", otp.current.value);
  ...
  const sendOTP = async () => {
   ...
   const result = await handleOTP(number.current.value, resend)
              ...
              <div className="col-md-6">
                <div className="login-form px-md-3 px-lg-5">
                  ...
                  <div className="input-group form-group">
                    ...
                    <input
                      ref={confirmPassword}
                      type={cnfmPasswordType? "password" : "text"}
                      name="text"
                      className="form-control px-2"
                    ...
                    />
                    <Link to="/signup">
                      <i onClick={handleCnfmPassword} className="fa fa-eye"></i>
                    </Link>
                  </div>
                  ...
                  <div className="d-flex align-items-center justify-content-center">
                    ...
                    <Link to="/login" className="text-link ms-2">
                      {" "}
                      Login Here
                    </Link>
                  </div>
