...
export const checkoutData = (hotelId, searchtoken, uniqueId) => {
  const url = `/getchekout`;
...
console.log("uniqueId", uniqueId, "params",params)
  const headers = {
    ContentType: "Application/json",
  };
...
export const getBasket = (checkoutMessage) => {
 console.log("getdataauth", checkoutMessage)
 
  const url = `/getbasket`;

  const params = {
    searchtoken: checkoutMessage,
  };
