...
const Result = () => {
  ...
  const applySelectedPricesFilter = useCallback(
    (data, selectedPrices) => {
  ...
  const applyStarRatingFilter = useCallback(
    (data, selectedStarRatings) => {
  ...
  const applyBoardTypeFilter = useCallback(
    (data, selectedBoardTypes) => {
